...
from .views import ParkingDetailsView, AddSlotsView
...
urlpatterns = [
    ...
    # path('api/v1/parkingarea', ParkingAreaPostView.as_view()),
    path('api/v1/parkingdetails', ParkingDetailsView.as_view()),
